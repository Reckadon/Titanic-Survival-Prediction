# prediction with Random Forest model and (Sex_male	Sex_female	is_child p_class) features
...
rf_model.fit(processed_train_data, train_set['Survived'])
...
predictions = rf_model.predict(processed_test_data)
prediction_df = pd.DataFrame(test_set['PassengerId'])
prediction_df['Survived'] = predictions

submission_filename = "./predictions/RandomForestModelSubmission.csv"
